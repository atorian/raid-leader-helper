...
[x] иконка у миникарты
[x] еще меньший размер ?
...
[x] что именно было сдиспелино?
[x] Отслеживать Змеиные ловушки
[x] Отслеживать отвлекающий выстрел
[ ] Автоначисление ЕП за закрытие инстов
[x] Выбор игрока по клику в логе
[ ] Эвенты в аддоне для передачи событий между зонами
