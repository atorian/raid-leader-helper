...
do
    ...
    local function memoize(func, cache)
        if not isCallable(func) then
            error(("Only functions and callable tables are memoizable. Received %s (a %s)"):format(tostring(func),
                type(func)), 2)
        end
...
do
    ...
    local barPrototype = setmetatable({
        ...
        SetStatusBarGradientAuto = function(self, r, g, b, a)
            self.fg:SetGradientAlpha(self.ORIENTATION, 0.5 + (r * 1.1), g * 0.7, b * 0.7, a, r * 0.7, g * 0.7,
                0.5 + (b * 1.1), a)
        end,
        ...
        SetScript = function(self, event, callback)
            if event == "OnValueChanged" then
                ...
                lib.RegisterCallback(self, "OnValueChanged", function()
    ...
    local barPrototype_mt = {
        __index = barPrototype
    }
...
local mixins = {"QuickDispatch", -- table util
"SafePack", "SafeUnpack", "tLength", "tCopy", "tInvert", "tIndexOf", "tAppendAll", "WeakTable", "Table", "TablePool",
-- lua memoize
                "memoize", -- math util
"Lerp", "Round", "Square", "Clamp", "WithinRange", "WithinRangeExclusive", "BreakUpLargeNumbers",
                "AbbreviateLargeNumbers", -- roster util
"IsInRaid", "IsInGroup", "IsInPvP", "GetNumGroupMembers", "GetNumSubgroupMembers", "GetGroupTypeAndCount",
                "IsGroupDead", "IsGroupInCombat", "GroupIterator", "UnitIterator", "UnitFullName", "C_PvP",
-- unit util
                "GetUnitIdFromGUID", "GetClassFromGUID", "GetCreatureId", "GetUnitCreatureId", "UnitHealthInfo",
                "UnitHealthPercent", -- backward compatibility
"UnitPowerInfo", "UnitIsGroupLeader", "UnitIsGroupAssistant", "GetUnitSpec", -- backward compatibility
"GetSpecialization", "GetInspectSpecialization", "GetSpecializationRole", "GetNumSpecializations",
                "GetSpecializationInfo", "GetSpecializationInfoByID", "UnitGroupRolesAssigned", "GetNumSpecGroups",
                "GetNumUnspentTalents", "GetActiveSpecGroup", "SetActiveSpecGroup", "GetUnitRole", "GetGUIDRole",
-- timer util
                "C_Timer", "After", "NewTicker", "NewTimer", "CancelTimer", -- color conversion
"HexToRGB", "RGBToHex", "HexToRGBPerc", "RGBPercToHex", -- misc util
"HexEncode", "HexDecode", "EscapeStr", "GetClassColorsTable", "GetClassColorObj", "GetClassColor", "GetNumClasses",
                "GetClassInfo", "Print", "Printf", "PassClickToParent", "Mixin", "CreateFromMixins",
                "CreateAndInitFromMixin", "ObjectPoolMixin", "CreateObjectPool", "FramePoolMixin", "FramePool_Hide",
                "FramePool_HideAndClearAnchors", "CreateFramePool", "TexturePoolMixin", "TexturePool_Hide",
                "TexturePool_HideAndClearAnchors", "CreateTexturePool", "ColorMixin", "CreateColor",
                "WrapTextInColorCode", "AnimatedNumericFontStringMixin", "StatusBarPrototype", "GetPhysicalScreenSize"}
